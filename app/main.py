...
if __name__ == "__main__":
    ...
    # server.remove_worker("7")
    # server.add_worker("Jan", "7")
    # server.remove_worker("7")
    # server.add_worker("Ania", "777")
    # server.add_worker("Maciej", "3030")
    # server.add_worker("John", "40110")
    # server.remove_worker("3030")
    # server.remove_worker("40110")
    # server.add_worker("Jan", "7")
    # server.add_card_to_worker("12", "4040")
    # server.add_card_to_worker("13", "4040")
